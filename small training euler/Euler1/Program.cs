...
"04 62 98 27 23 09 70 98 73 93 38 53 60 04 23";
        ...
        //Find the sum of all the positive integers which cannot be written as the sum of two abundant numbers.
        {
            ...
            Console.WriteLine(" sum of positive integers composed of abundant numbers is: {0}", sum);
            ...
            {bool flag = false;
                ...
                {
                    if (a + abundant[k] > UpperBound - 1) break;
                    else
                    {
            ...
            {
                List<int> listofprimes = divisors();

                for (int k = 12; k < 28123;  k++)
                {
            ...
            {
                List<int> primes = new List<int>();
                for (int i = LowerBound; i <= Math.Sqrt(UpperBound)+1; i++)
                {
            ...
            int[] optimizedividers(int[] b, int c)
            {
               ...
               // Console.WriteLine("list of divisors for {0} is :: {1}",c, string.Join((char)32, dividerslist));
                return dividerslist.ToArray();
            }
