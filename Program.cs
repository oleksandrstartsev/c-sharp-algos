...
#pragma warning restore CS8321 // Local function is declared but never used
        ...
        //just use Binet's formula for elegant solution: golden ratio approach;
        static void LargeFibo()
        {
            double phi= 1.6180;
            int digits = 1000 - 1;
            double nb = ((Math.Log10(10) * digits + (Math.Log10(5) / 2.0)) / (Math.Log10(phi)));
